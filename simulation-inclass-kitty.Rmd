...
```{r}
mcGamblers_auto = function(bankroll = 50000, betCost = 100, numHands = 100, init = .46) {
  difference = 55000
  while (abs(difference) > 50000) {
    ...
    if (difference = bankroll - 50000
}

 {
  
      }
      return(c(difference, bankroll,init))
  }
```
